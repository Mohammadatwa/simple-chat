        ...
        fireauth.createUserWithEmailAndPassword(email,pw).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()){
                    Toast.makeText(RegActivity.this,"Registration Complete", Toast.LENGTH_SHORT).show();
                ...
                else { Toast.makeText(RegActivity.this,"Registration Failed, please try again", Toast.LENGTH_SHORT).show();
                }
